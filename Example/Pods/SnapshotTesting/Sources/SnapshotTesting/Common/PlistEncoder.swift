...
private struct _PlistKeyedEncodingContainer<K: CodingKey>: KeyedEncodingContainerProtocol {
  ...
  public mutating func superEncoder() -> Encoder {
    return _PlistReferencingEncoder(referencing: encoder, at: _PlistKey.super, wrapping: container)
  }

  public mutating func superEncoder(forKey key: Key) -> Encoder {
    return _PlistReferencingEncoder(referencing: encoder, at: key, wrapping: container)
  }
}
...
private struct _PlistUnkeyedEncodingContainer: UnkeyedEncodingContainer {
  ...
  public mutating func superEncoder() -> Encoder {
    return _PlistReferencingEncoder(referencing: encoder, at: container.count, wrapping: container)
  }
}
